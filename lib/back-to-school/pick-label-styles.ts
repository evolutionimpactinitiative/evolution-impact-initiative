...
//
// Type sizes pushed aggressively — 4×6 is big enough to read across a
// table so nothing should be tiny. If a busy label overflows we'd
// rather clip the school/notes line than shrink the pick list.
...
export const PICK_LABEL_PRINT_STYLES = `
  ...
  .pl-child-name {
    font-size: 26pt; font-weight: 900; line-height: 1.05;
    margin: 1mm 0 1mm 0; word-break: break-word;
  }
  .pl-parent {
    font-size: 12pt; color: #333; margin: 0; line-height: 1.2;
  }
  .pl-parent strong { font-weight: 700; }
  .pl-meta {
    font-size: 10pt; color: #444; margin: 1mm 0 0 0; font-weight: 500;
  }
  ...
  .pl-section-label {
    ...
    border-top: 0.7mm solid #111; padding-top: 1.5mm;
  }

  .pl-items { list-style: none; padding: 0; margin: 0; }
  .pl-item {
    display: flex; align-items: baseline; gap: 2mm;
    font-size: 12pt; padding: 1mm 0;
    border-bottom: 0.2mm dotted #ccc;
  }
  .pl-item-check { font-size: 16pt; line-height: 1; }
  .pl-item-label { flex: 1; font-weight: 500; }
  .pl-item-given {
    display: inline-flex; gap: 1.5mm; font-size: 9pt; color: #555;
    align-items: baseline;
  }
  .pl-item-given-label { flex-shrink: 0; font-weight: 600; }
  .pl-blank {
    display: inline-block; border-bottom: 0.35mm solid #666;
    height: 4mm; min-width: 24mm;
  }
  ...
  .pl-note {
    font-size: 9pt; background: #FEF3C7; padding: 2mm;
    border-radius: 1.5mm; margin: 1.5mm 0 0 0; line-height: 1.3;
  }
  .pl-note strong { font-weight: 700; }

  .pl-bottom {
    display: flex; gap: 3mm; align-items: flex-start;
    border-top: 0.7mm solid #111; padding-top: 2mm; margin-top: auto;
  }
  .pl-qr-wrap { flex-shrink: 0; }
  .pl-qr { width: 38mm; height: 38mm; display: block; }
  .pl-qr-placeholder {
    width: 38mm; height: 38mm; border: 0.3mm dashed #999;
    display: flex; align-items: center; justify-content: center;
    font-size: 7pt; color: #999; text-align: center; padding: 1mm;
  }

  .pl-outcome {
    flex: 1; display: flex; flex-direction: column; gap: 1.5mm;
    font-size: 11pt;
  }
  .pl-outcome-label {
  ...
  .pl-outcome-check { font-size: 12pt; line-height: 1.25; }

  .pl-footer {
    display: flex; justify-content: space-between; align-items: baseline;
    font-size: 9pt; color: #444; margin-top: 1.5mm; font-weight: 500;
  }
  .pl-ref {
